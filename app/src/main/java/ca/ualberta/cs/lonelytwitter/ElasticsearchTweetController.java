...
public class ElasticsearchTweetController {
        ...
        protected Void doInBackground(NormalTweet... tweets) {
            ...
            for (NormalTweet tweet : tweets) {
                ...
                try {
                    ...
                    else {Log.i("Error", "Elasticsearch  was not able to add the Tweet.");}
                }
                catch (Exception e) {
    ...
    public static class GetTweetsTask extends AsyncTask<String, Void, ArrayList<NormalTweet>> {
        ...
        protected ArrayList<NormalTweet> doInBackground(String... search_parameters) {
            ...
            String query = "_search?q=tweet:"+search_parameters[0];
            ...
            Search.Builder search = new Search.Builder(query).addIndex("testing").addType("tweet");
            ...
            try {
               // TODO get the results of the query
                ...
                if (result.isSucceeded()) {
                    ...
                    Log.i("Error", "The search query fialed to find any tweets that matched");
                }
            }
            catch (Exception e) {
